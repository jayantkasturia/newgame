...
const Login = () => {
    ...
    return (
        <div>
            {userLoggedIn && (<Navigate to={'/auth/user'} replace={true} />)}
            <main className="w-full  flex self-center place-content-center place-items-center">
                <div className=" text-gray-600 space-y-2 p-4 shadow-xl border rounded-xl">
                    ...
                    >
                        <div>
                            ...
                            <input
                                ...
                                style={{ width: '100%', marginTop: '0.5rem', padding: '0.75rem', color: '#374151', backgroundColor: 'transparent', outline: 'none', border: '1px solid #D1D5DB', borderRadius: '0.375rem', transition: 'border-color 0.3s', boxShadow: '0 0 0 1px transparent' }}
                            />
                        </div>
                        <div>
                            <label className="text-sm text-gray-600 font-bold">
